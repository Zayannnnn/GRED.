...
function InvestSuccessApp() {
  ...
  <div className="success-container">
    <div className="success-card">
      ...
      <h1 className="success-title">Inquiry Successfully Logged</h1>
      <p className="success-desc">
        Thank you for your interest in GRED. Our corporate development desk has securely captured your strategic notes and allocation bracket. A regional partner will contact you shortly.
      </p>
...
export default InvestSuccessApp;
